  ...
  return (
    <div className={cn('space-y-4', className)}>
      ...
      {pagination && sortedData.length > 0 && (
        <div className="px-4 sm:px-6 py-4 bg-white border border-slate-200 rounded-lg">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="rounded-md border border-slate-300 bg-white px-2 py-1.5 text-sm font-medium text-slate-700 hover:bg-slate-50 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition-colors"
              >
            ...
            <div className="text-sm text-slate-600 font-medium">
              {sortedData.length > 0 ? (
                <span>
                  ...
                  {Math.min(currentPage * itemsPerPage, sortedData.length)} {t('common.of')}{' '}
                  {sortedData.length}
                </span>
              ) : (
                <span>0 {t('common.of')} 0</span>
              )}
            </div>

            {/* Right: Navigation or Load More */}
            <div className="flex items-center gap-3">
              ...
              {/* Load More Button - inline with pagination */}
              {hasMore && onLoadMore && (
                <button
                  onClick={onLoadMore}
                  disabled={loadingMore}
                  className={cn(
                    "px-4 py-1.5 rounded-md font-medium text-sm transition-all whitespace-nowrap",
