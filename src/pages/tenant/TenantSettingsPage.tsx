 ...
 * TenantSettingsPage
 * 
 * Standalone page for tenant-level settings.
 * Covers org info, branding, regional settings, and notification preferences.
 */

import React from 'react';
import { useNavigate } from 'react-router-dom';
import { PageHeader, Loading } from '../../components/ui';
import { TenantSettings } from '../../components/tenant-dashboard';
...
const TenantSettingsPage: React.FC = () => {
  ...
  if (roleLoading) {
    return <Loading title="Loading Tenant Settings" description="Determining your access level..." variant="primary" />;
  }
      ...
      <div className="space-y-6 p-4 sm:p-6 bg-gray-50 min-h-screen">
        <div className="max-w-md mx-auto text-center py-24">
          ...
          <p className="text-gray-500 mb-6">
            Tenant settings are available to <strong>Owner</strong> and <strong>Admin</strong> roles only.
    ...
    return (
      <div className="space-y-6 p-4 sm:p-6 bg-gray-50 min-h-screen">
        <div className="max-w-md mx-auto text-center py-24">
          ...
          <p className="text-gray-500 mb-6">Please select an organization to manage settings.</p>
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={`Organization settings for ${currentTenant.name}`}
      />
      <TenantSettings />
    </div>
  );
